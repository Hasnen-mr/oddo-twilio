...
$zipCandidates += (Join-Path $ScriptDir "..\packages\twilio_dialer_$($odooVersion).0.zip")
$zipCandidates += (Join-Path $ScriptDir "..\packages\twilio_dialer.zip")
$zipCandidates += (Join-Path $ScriptDir "packages\twilio_dialer_$($odooVersion).0.zip")
$zipCandidates += (Join-Path $ScriptDir "packages\twilio_dialer.zip")
...
$zipCandidates += (Join-Path $RepoRoot "packages\twilio_dialer.zip")
