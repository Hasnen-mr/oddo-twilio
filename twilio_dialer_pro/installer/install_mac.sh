...
# Relative lookup from installer/ directory to packages/
ZIP_CANDIDATES+=("$SCRIPT_DIR/../packages/twilio_dialer_$ODOO_VERSION.0.zip")
ZIP_CANDIDATES+=("$SCRIPT_DIR/../packages/twilio_dialer.zip")
ZIP_CANDIDATES+=("$SCRIPT_DIR/packages/twilio_dialer_$ODOO_VERSION.0.zip")
ZIP_CANDIDATES+=("$SCRIPT_DIR/packages/twilio_dialer.zip")
...
ZIP_CANDIDATES+=("$REPO_ROOT/packages/twilio_dialer.zip")
